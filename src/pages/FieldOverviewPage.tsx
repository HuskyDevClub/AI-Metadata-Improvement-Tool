    ...
    return (
        <div className="field-overview-page">
            <div className="field-overview-nav">
                ...
                <div className="field-overview-pager">
                    <div className="field-overview-pager-group">
                        { prevField &&
                            <span className="field-overview-pager-label" title={ prevField }>{ prevField }</span> }
                        { prevField ? (
                    ...
                    <div className="field-overview-pager-group">
                        ...
                        { nextField &&
                            <span className="field-overview-pager-label" title={ nextField }>{ nextField }</span> }
                    </div>
                </div>
            </div>
            ...
            <div className="field-overview-header">
                ...
                <DataTypeBadge type={ info.type } originalType={ info.originalType } baseType={ info.baseType }
                               size="large"/>
            </div>
